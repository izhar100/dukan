        ...
        <div>
            <Box fontFamily={"Inter"}>
                ...
                <Flex mt={"20px"} gap={"12px"}>
                    <Text p={"6px 16px"} color={"white"} borderRadius={"full"} bgColor={"#146EB4"} cursor={"pointer"} onClick={()=>handlePage("payout")}
                    >Payouts (22)</Text>
                    <Text p={"6px 16px"} color={"#808080"} borderRadius={"full"} bgColor={"#E6E6E6"} cursor={"pointer"} onClick={()=>handlePage("refund")}>Refunds (2)</Text>
                </Flex>
                <Box mt={"24px"} px={"12px"} pt={"12px"} pb={"8px"} bgColor={"white"}>
                    ...
                    {
                        arr?.map((el,i) => (
                            <Flex key={el.orderId} color={"#1A181E"} py={"14px"} px={"12px"} bgColor={"#ffffff"} justifyContent={"space-between"} borderBottom={(arr.length-1)==i?"":"1px solid #E6E6E6"}  fontSize={"14px"} fontWeight={400}
                            >
